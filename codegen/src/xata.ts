import { BaseClient, Repository, RestRespositoryFactory, XataClientOptions, XataRecord } from '@xata.io/client';
...
export class XataClient extends BaseClient<{
  ...
  constructor(options?: XataClientOptions) {
    super({ databaseURL: 'https://test-r5vcv5.xata.sh/db/todo', ...options }, links);
