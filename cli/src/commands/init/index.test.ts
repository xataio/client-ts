  ...
  test('generates typescript types', async () => {
    ...
    expect(outputFiles).toMatchInlineSnapshot(`
      ...
      ",
        ...
        "readme.md": "",
        "xataCustom.ts": "// Generated by Xata Codegen 0.26.5. Please do not edit.
    ...
    expect(warn.mock.calls.flat()).toEqual(
      expect.arrayContaining([
        expect.stringContaining(
          'No package.json found. Please run one of: bun init, pnpm init, yarn init, npm init. Then rerun'
        )
      ])
    );
