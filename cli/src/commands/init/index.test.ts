...
import { getDirectoryAsObject, mockFileSystem } from '../../utils/mockFs';
...
const runInitTest = async (
  ...
  const outputFiles = getDirectoryAsObject('.');
  mockFs.restore();

  return { log, promptsMock, outputFiles };
};
...
describe('xata init', () => {
  test('errors when .xatarc already exists', async () => {
    await expect(
      ...
      '[Error: Project already configured at /Users/richardgill/Workspace/xata/client-ts/.xatarc. Use --force to overwrite it]'
    );
  });
  ...
  test('generates typescript types', async () => {
    ...
    expect(outputFiles).toMatchInlineSnapshot(`
      ...
      ",
        ...
        "readme.md": "",
        "src/xataCustom.ts": "// Generated by Xata Codegen 0.23.5. Please do not edit.
