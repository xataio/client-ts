...
import { VERSION } from '@xata.io/codegen/src/version';
...
describe('xata init', () => {
  ...
  test('generates typescript types', async () => {
    ...
    expect(JSON.stringify(outputFiles)).toMatchInlineSnapshot(`
      {
      ...
      ",
        ...
        "readme.md": "",
        "xataCustom.ts": "// Generated by Xata Codegen ${VERSION}. Please do not edit.
