/**
 * @deprecated
 * This file is deprecated and will be removed when
 * all branches have been upgraded to pgroll.
 */
...
export default class EditSchemaOld extends BaseCommand<typeof EditSchemaOld> {
